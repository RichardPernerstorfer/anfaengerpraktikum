...
### Barplot Covid Faelle in Muenchen 


ggplot(data = data_muc_aug_bis_nov, aes(x = date, y = faelle_covid_aktuell)) +
  ggtitle("Corona Fälle in Muenchen von August bis November") +
  xlab("Datum") + ylab("Aktuelle Covid Fälle") + geom_bar(stat="identity")


### Gemeinsamer Bar-Plot Muc in August


ggplot(data = data_muc_aug, aes(x=date)) +
